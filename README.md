...
![点云工作台主界面](docs/images/main-window.png)
...
点云工作台把常见点云任务集中到一个中文桌面界面中：打开一份点云或 OLX 会话后，可以立即检查数据质量和场景尺寸，完成点、线、角度、面积、平面和圆的测量，再继续做局部分析、双时相对比、坐标变换、工程保存和报告输出。
...
安装完成后，双击桌面的“点云工作台”。如果 Ubuntu 把图标显示为普通文本文件，请右键图标，选择“允许启动”或“信任并启动”，再双击一次。
